  ...
  <>
    <nav className={`navbar px-5  ${scrolling ? 'navbar-scrolled' : ''} ${location.pathname.startsWith('/home/card/') ? 'nonavbar' : ''} ${location.pathname === '/membershipcard' ? 'navbar_top' : ''} ${location.pathname === '/userprofile' ? 'navbar_top' : ''} ${location.pathname !== '/login' ? 'navbar-white' : ''} ${location.pathname === '/dashboard' ? 'navbar_dash' : ''} ${location.pathname==='/about'?'navbar_top':''}  ${location.pathname==='/login' || location.pathname==='/forgotpass' || location.pathname==='/newpass' || location.pathname==='/signup'?'nonavbar':''} ${location.pathname==='/signup'?'navbar_top':''} ${location.pathname==='/userdashboard'?'navbar_top':''} ${location.pathname==='/pricing'?'navbar_top':''} ${location.pathname === '/otp' ? 'nonavbar' : ''}`}>
      ...
      <ul className="nav-links-mobile">
        ...
        <li>
          <Link className={`nav-link ${scrolling ? 'nav-links-scrolled' : ''} ${location.pathname === '/stockview' ? 'active' : ''} ${location.pathname !== '/' ? 'nav-link-white' : ''}`} to={`${config.baseUrl}stockview`} onClick={navlinclickfunc} title='Stocks'>Stocks Tracker</Link>
        </li>
        <li>
      ...
      <ul className="nav-links">
        <li>
          <Link className={`${location.pathname === '/stockview' ? 'nav-link-stock' : 'nav-link'}  ${scrolling ? 'nav-links-scrolled' : ''} ${location.pathname === '/' ? 'active' : ''} ${location.pathname !== '/' ? 'nav-link-white' : ''}`} to={`${config.baseUrl}`} onClick={navlinclickfunc} title='Home'>Home</Link>
        </li>
        <li>
          <Link className={`${location.pathname === '/stockview' ? 'nav-link-stock' : 'nav-link'} ${scrolling ? 'nav-links-scrolled' : ''} ${location.pathname === '/about' ? 'active' : ''} ${location.pathname !== '/' ? 'nav-link-white' : ''}`} to={`${config.baseUrl}about`} onClick={navlinclickfunc} title='About Us'>About Us</Link>
        </li>
        <li>
          <Link className={`${location.pathname === '/stockview' ? 'nav-link-stock' : 'nav-link'} ${scrolling ? 'nav-links-scrolled' : ''} ${location.pathname === '/stockview' ? 'activestock' : ''} ${location.pathname === '/stockview' && scrolling ? 'activescrolled' : ''} ${location.pathname !== '/' ? 'nav-link-white' : ''}`} to={`${config.baseUrl}stockview`} onClick={navlinclickfunc} title='Stocks'>Stocks</Link>
        </li>
        <li>
          <Link className={`${location.pathname === '/stockview' ? 'nav-link-stock' : 'nav-link'} ${scrolling ? 'nav-links-scrolled' : ''} ${location.pathname === '/contact' ? 'active' : ''} ${location.pathname !== '/' ? 'nav-link-white' : ''}`} to={`${config.baseUrl}contact`} onClick={navlinclickfunc} title='Contact Us'>Contact Us</Link>
        </li>
        {/* Pricing, to='/pricing' */}
        <li>
          <Link className={`${location.pathname === '/stockview' ? 'nav-link-stock' : 'nav-link'} ${scrolling ? 'nav-links-scrolled' : ''} ${location.pathname === '/pricing' ? 'active' : ''} ${location.pathname !== '/' ? 'nav-link-white' : ''}`} onClick={navlinclickfunc} to={`${config.baseUrl}pricing`} title='Pricing'>Pricing</Link>
        </li>
      </ul>
